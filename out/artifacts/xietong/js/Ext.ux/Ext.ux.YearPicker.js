...
Ext.reg('ux.monthpicker', Ext.ux.YearPicker);
...
Ext.extend(Ext.ux.YearField, Ext.form.DateField, {
    ...
    noPastMonths: Ext.ux.YearPicker.prototype.noPastMonths,
...
Ext.reg('ux.yearfield', Ext.ux.YearMenu);