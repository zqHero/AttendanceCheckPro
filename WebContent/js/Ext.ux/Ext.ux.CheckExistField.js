 ...
 */
Ext.ux.CheckExistField = Ext.extend(Ext.form.Field,  {
	
	checkable:true,
	
	checkUrl:'',
	
	checkFailedText:' {0} 已存在',
    /**
    ...
    initComponent : function(){
        Ext.ux.CheckExistField.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event autosize
    ...
    // private
    initEvents : function(){
        Ext.ux.CheckExistField.superclass.initEvents.call(this);
     ...
     */
    reset : function(){
        Ext.ux.CheckExistField.superclass.reset.call(this);
        this.applyEmptyText();
    },
    ...
    setValue : function(v){
        ...
        Ext.ux.CheckExistField.superclass.setValue.apply(this, arguments);
        this.applyEmptyText();
        this.autoSize();
    },
        ...
        if(this.checkable) {
        	...
        	Ext.Ajax.request({
			    ...
			    success: function(response){
					...
					if(result == 'true'){ 
						field.markInvalid(String.format(field.checkFailedText,field.getValue()));
            			return false;
...
Ext.reg('checkusernamefield', Ext.ux.CheckExistField);
